...
void egyikGlobalFunkcio(); // csak szoltunk, h lesz egy ilyen tehat deklaracio
void masikGlobalFunkcio();

namespace ezEgyNamespace 
{	// ez egy namespace, ami segit elkerulni a nevek osszekeveredeset. 
